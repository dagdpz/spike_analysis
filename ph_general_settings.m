...
keys.basepath_to_save       =['Projects\' project '\ephys'];
...
keys.colors.NH_IN   =[255 0 0];
keys.colors.NH_CH   =[180 0 0];
keys.colors.IH_IN   =[0 0 255];
keys.colors.IH_CH   =[0 0 100];
keys.colors.CH_IN   =[0 255 0];
keys.colors.CH_CH   =[0 127 0];
keys.colors.IS_IN   =[255 153 20];
keys.colors.IS_CH   =[127 75 10];
keys.colors.CS_IN   =[255 0 178];
keys.colors.CS_CH   =[127 0 90];

% single cell PSTH colors per position
keys.colors.NH_IN   =[255 0 0];
keys.colors.NH_CH   =[180 0 0];
keys.colors.LH_IN   =[0 0 255];
keys.colors.LH_CH   =[0 0 100];
keys.colors.RH_IN   =[0 255 0];
keys.colors.RH_CH   =[0 127 0];

% single cell PSTH colors per hemifield
keys.colors.NH_RS_IN=[255 153 20];
keys.colors.NH_RS_CH=[127 77 10];
keys.colors.LH_RS_IN=[125 130 255];
keys.colors.LH_RS_CH=[62 65 127];
keys.colors.RH_RS_IN=[145 255 56];
keys.colors.RH_RS_CH=[77 125 28];
keys.colors.NH_LS_IN=[255 0 178];
keys.colors.NH_LS_CH=[127 0 89];
keys.colors.LH_LS_IN=[171 0 252];
keys.colors.LH_LS_CH=[85 0 126];
keys.colors.RH_LS_IN=[222 220 0];
keys.colors.RH_LS_CH=[110 110 0];

% population contra ipsi PSTH colors
keys.colors.NH_CS_IN=[255 0 178];
keys.colors.NH_CS_CH=[127 0 89];
keys.colors.IH_CS_IN=[222 220 0];
keys.colors.IH_CS_CH=[110 110 0];
keys.colors.CH_CS_IN=[171 0 252];
keys.colors.CH_CS_CH=[85 0 126];


keys.colors.NH_IS_IN=[255 153 20];
keys.colors.NH_IS_CH=[127 77 10];
keys.colors.IH_IS_IN=[145 255 56];
keys.colors.IH_IS_CH=[77 125 28];
keys.colors.CH_IS_IN=[125 130 255];
keys.colors.CH_IS_CH=[62 65 127];


keys.colors.NH_VS_IN=[150 150 150];
keys.colors.NH_VS_CH=[80 80 80];
keys.colors.IH_VS_IN=[150 255 150];
keys.colors.IH_VS_CH=[80 255 80];
keys.colors.CH_VS_IN=[150 150 255];
keys.colors.CH_VS_CH=[80 80 255];

% population effector coslors
