...
if strcmp(Sel_for_title{3,1},'MIP_L')
...
if keys.ST.combine_exp_conditions
    ...
    conditions_plot = [0 4 1 0 0;0 4 2 0 0;-1 4 0 0 0;1 4 0 0 0;0 4 1 0 1;0 4 2 0 1;-1 4 0 0 1;1 4 0 0 1;conditions_hf_complete(5:8,:)];
    ...
    for nstr = 1:size(exp_cond_names,1)
        ...
        for ncond = 1:numel(hnd_spa_names)
            ...
            %             plot(smooth(euclidian_distances.(exp_cond_names{nstr}).(hnd_spa_names{ncond})),'color',keys.line_colors(col,:),'LineWidth',1.5);
