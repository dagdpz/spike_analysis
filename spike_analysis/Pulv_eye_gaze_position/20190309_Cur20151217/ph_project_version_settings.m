keys.project_version='20190309_Cur20151217';
...
keys.ANOVAS_PER_TYPE(3).spaceLR            ={'Fhol','Cue','MemE','MemL','PreS','PeriS','TIhol','Tons','Thol'}';
keys.ANOVAS_PER_TYPE(3).positions          ={'Fhol','Cue','MemE','MemL','PreS','PeriS','TIhol','Tons','Thol'}';
keys.ANOVAS_PER_TYPE(3).hands              ={'Fhol','Cue','MemE','MemL','PreS','PeriS','TIhol','Tons','Thol'}';
keys.ANOVAS_PER_TYPE(3).SxH                ={'Fhol','Cue','MemE','MemL','PreS','PeriS','TIhol','Tons','Thol'}';
keys.ANOVAS_PER_TYPE(3).main               ={'INI','Fhol','Cue','MemE','MemL','PreS','PeriS','TIhol','Tons','Thol'}';
...
%% gaze analysis settings
            ...
            keys.gaz(cc).group_parameter            = 'Initial_Gaze';
            keys.gaz(cc).conditions_to_plot         = {'Msac'};
            keys.gaz(cc).FR_subtract_baseline       = 0;
            keys.gaz(cc).tt.combine_tuning_properties  = {'Initial_Gaze','in_AH_Fhol_gaze_modulation_Msac_fix','in_AH_Fhol_position_Msac_fix','in_AH_Fhol_gaze_pref_Msac_fix'};
            % keys.gaz(cc).unselect                   = {'Gain_fields','monotoneussingleton';'Gain_fields','nonmonotoneussingleton'};
