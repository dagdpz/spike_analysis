keys.pdf_folder='v20161108_INI_extended';
...
%keys.Linus.date             ='[20160224 20160606]';
keys.task_types             ={'del'};
keys.datasets               ={'Dcfr','Ddre','Ddsa'};
keys.case_summaries         ={'hands'};
keys.cell_count_factors     ={'epoch','space','hand'};
keys.FR_subtract_baseline   =0;
keys.only_both_hands        =1;
keys.cases_for_population_PSTH=              99:104;%1:98;%1:63;%58:60;%1:57;
...
keys.CCepochsS.Ddre	={'INI','Facq','Fhol','Cue'}';
keys.CCepochsS.Dcfr	={'INI','Facq','Fhol','Cue'}';
keys.CCepochsS.Ddsa	={'INI','Facq','Fhol','Cue'}';
