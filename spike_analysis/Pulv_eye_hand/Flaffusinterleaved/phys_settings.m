%keys.pdf_folders={'v20161208interleaved','v20161208blocked','Flaffusinterleaved'};
keys.pdf_folders={''};
keys.pdf_folder='Flaffusinterleaved';
...
keys.epochs_to_plot_PSTH{4}                 ={'INI','Facq','Cue','PeriS','PeriR'}';
