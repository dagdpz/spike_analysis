...
keys.targets                ={'dPulv_r','dPulv_l','dPulv'};
...
%% cell count settings
keys.cell_count_factors         ={'choice2','choice1','epoch','space'};
...
keys.epochs_SxH_multicomp{2}                ={'INI','Facq','Fhol','Cue','PreS','PeriS','Tacq','Thol'}';
...
keys.epochs_SxH_multicomp{3}                ={'INI','Facq','Fhol','Cue','MemE','MemL','PreS','PeriS','TIhol','Thol'}';
keys.epochs_to_plot_PSTH{3}                 ={'Cue','PeriS','Thol'}';
