...
keys.project_version='LIP_dPul_Inj';
...
keys.cc.conditions_to_plot              ={'Ddsa'};
...
% 1
cc=cc+1;
keys.pop(cc).combine_tuning_properties  ={'hand_tuning','in_IH_Facq_epoch_Ddsa_han','in_CH_Facq_epoch_Ddsa_han'};
...
keys.pop(cc).epoch_for_normalization    = 'INI';               % epoch used for (divisive) normalization
...
%Cue
cs=cs+1;
keys.sct(cs).X='in_IH_IS_Cue_CT_FR_Ddsa_han';
keys.sct(cs).Y='in_IH_IS_Cue_PT_FR_Ddsa_han';
keys.sct(cs).X_sig='in_IH_IS_Cue_PT_Ddsa_han'; % O > ^ o (filled) 
keys.sct(cs).Y_sig='in_IH_IS_Cue_PT_Ddsa_han';
keys.sct(cs).tt.tasktypes={'Ddsa_han'};
...
cs=cs+1;
keys.sct(cs).X='in_IH_CS_Cue_CT_FR_Ddsa_han';
keys.sct(cs).Y='in_IH_CS_Cue_PT_FR_Ddsa_han';
keys.sct(cs).X_sig='in_IH_CS_Cue_PT_Ddsa_han';
...
cs=cs+1;
keys.sct(cs).X='in_CH_CS_Cue_CT_FR_Ddsa_han';
keys.sct(cs).Y='in_CH_CS_Cue_PT_FR_Ddsa_han';
keys.sct(cs).X_sig='in_CH_CS_Cue_PT_Ddsa_han';
...
cs=cs+1;
keys.sct(cs).X='in_CH_IS_Cue_CT_FR_Ddsa_han';
keys.sct(cs).Y='in_CH_IS_Cue_PT_FR_Ddsa_han';
keys.sct(cs).X_sig='in_CH_IS_Cue_PT_Ddsa_han';
keys.sct(cs).Y_sig='in_CH_IS_Cue_PT_Ddsa_han';
keys.sct(cs).tt.tasktypes={'Ddsa_han'};
keys.sct(cs).tt.IC_for_criterion='in';
keys.sct(cs).tt.hands=[1 2];
keys.sct(cs).tt.choices=[0];
...
%Del
cs=cs+1;
keys.sct(cs).X='in_IH_IS_Del_CT_FR_Ddsa_han';
keys.sct(cs).Y='in_IH_IS_Del_PT_FR_Ddsa_han';
keys.sct(cs).X_sig='in_IH_IS_Del_PT_Ddsa_han'; % O > ^ o (filled) 
keys.sct(cs).Y_sig='in_IH_IS_Del_PT_Ddsa_han';
keys.sct(cs).tt.tasktypes={'Ddsa_han'};
keys.sct(cs).tt.IC_for_criterion='in';
keys.sct(cs).tt.hands=[1 2];
keys.sct(cs).tt.choices=[0];
...
cs=cs+1;
keys.sct(cs).X='in_IH_CS_Del_CT_FR_Ddsa_han';
keys.sct(cs).Y='in_IH_CS_Del_PT_FR_Ddsa_han';
keys.sct(cs).X_sig='in_IH_CS_Del_PT_Ddsa_han';
...
cs=cs+1;
keys.sct(cs).X='in_CH_CS_Del_CT_FR_Ddsa_han';
keys.sct(cs).Y='in_CH_CS_Del_PT_FR_Ddsa_han';
keys.sct(cs).X_sig='in_CH_CS_Del_PT_Ddsa_han';
...
cs=cs+1;
keys.sct(cs).X='in_CH_IS_Del_CT_FR_Ddsa_han';
keys.sct(cs).Y='in_CH_IS_Del_PT_FR_Ddsa_han';
keys.sct(cs).X_sig='in_CH_IS_Del_PT_Ddsa_han';
keys.sct(cs).Y_sig='in_CH_IS_Del_PT_Ddsa_han';
keys.sct(cs).tt.tasktypes={'Ddsa_han'};
keys.sct(cs).tt.IC_for_criterion='in';
keys.sct(cs).tt.hands=[1 2];
keys.sct(cs).tt.choices=[0];
...
%PreR
cs=cs+1;
keys.sct(cs).X='in_IH_IS_PreR_CT_FR_Ddsa_han';
keys.sct(cs).Y='in_IH_IS_PreR_PT_FR_Ddsa_han';
keys.sct(cs).X_sig='in_IH_IS_PreR_PT_Ddsa_han'; % O > ^ o (filled) 
keys.sct(cs).Y_sig='in_IH_IS_PreR_PT_Ddsa_han';
keys.sct(cs).tt.tasktypes={'Ddsa_han'};
keys.sct(cs).tt.IC_for_criterion='in';
keys.sct(cs).tt.hands=[1 2];
keys.sct(cs).tt.choices=[0];
...
cs=cs+1;
keys.sct(cs).X='in_IH_CS_PreR_CT_FR_Ddsa_han';
keys.sct(cs).Y='in_IH_CS_PreR_PT_FR_Ddsa_han';
keys.sct(cs).X_sig='in_IH_CS_PreR_PT_Ddsa_han';
keys.sct(cs).Y_sig='in_IH_CS_PreR_PT_Ddsa_han';
keys.sct(cs).tt.tasktypes={'Ddsa_han'};
keys.sct(cs).tt.IC_for_criterion='in';
keys.sct(cs).tt.hands=[1 2];
keys.sct(cs).tt.choices=[0];
...
cs=cs+1;
keys.sct(cs).X='in_CH_CS_PreR_CT_FR_Ddsa_han';
keys.sct(cs).Y='in_CH_CS_PreR_PT_FR_Ddsa_han';
keys.sct(cs).X_sig='in_CH_CS_PreR_PT_Ddsa_han';
keys.sct(cs).Y_sig='in_CH_CS_PreR_PT_Ddsa_han';
keys.sct(cs).tt.tasktypes={'Ddsa_han'};
keys.sct(cs).tt.IC_for_criterion='in';
keys.sct(cs).tt.hands=[1 2];
keys.sct(cs).tt.choices=[0];
...
cs=cs+1;
keys.sct(cs).X='in_CH_IS_PreR_CT_FR_Ddsa_han';
keys.sct(cs).Y='in_CH_IS_PreR_PT_FR_Ddsa_han';
keys.sct(cs).X_sig='in_CH_IS_PreR_PT_Ddsa_han';
keys.sct(cs).Y_sig='in_CH_IS_PreR_PT_Ddsa_han';
keys.sct(cs).tt.tasktypes={'Ddsa_han'};
keys.sct(cs).tt.IC_for_criterion='in';
keys.sct(cs).tt.hands=[1 2];
keys.sct(cs).tt.choices=[0];
...
%PeriR
cs=cs+1;
keys.sct(cs).X='in_IH_IS_PeriR_CT_FR_Ddsa_han';
keys.sct(cs).Y='in_IH_IS_PeriR_PT_FR_Ddsa_han';
keys.sct(cs).X_sig='in_IH_IS_PeriR_PT_Ddsa_han'; % O > ^ o (filled) 
keys.sct(cs).Y_sig='in_IH_IS_PeriR_PT_Ddsa_han';
keys.sct(cs).tt.tasktypes={'Ddsa_han'};
keys.sct(cs).tt.IC_for_criterion='in';
keys.sct(cs).tt.hands=[1 2];
keys.sct(cs).tt.choices=[0];
...
cs=cs+1;
keys.sct(cs).X='in_IH_CS_PeriR_CT_FR_Ddsa_han';
keys.sct(cs).Y='in_IH_CS_PeriR_PT_FR_Ddsa_han';
keys.sct(cs).X_sig='in_IH_CS_PeriR_PT_Ddsa_han';
keys.sct(cs).Y_sig='in_IH_CS_PeriR_PT_Ddsa_han';
keys.sct(cs).tt.tasktypes={'Ddsa_han'};
keys.sct(cs).tt.IC_for_criterion='in';
keys.sct(cs).tt.hands=[1 2];
keys.sct(cs).tt.choices=[0];
...
cs=cs+1;
keys.sct(cs).X='in_CH_CS_PeriR_CT_FR_Ddsa_han';
keys.sct(cs).Y='in_CH_CS_PeriR_PT_FR_Ddsa_han';
keys.sct(cs).X_sig='in_CH_CS_PeriR_PT_Ddsa_han';
keys.sct(cs).Y_sig='in_CH_CS_PeriR_PT_Ddsa_han';
keys.sct(cs).tt.tasktypes={'Ddsa_han'};
keys.sct(cs).tt.IC_for_criterion='in';
keys.sct(cs).tt.hands=[1 2];
keys.sct(cs).tt.choices=[0];
...
cs=cs+1;
keys.sct(cs).X='in_CH_IS_PeriR_CT_FR_Ddsa_han';
keys.sct(cs).Y='in_CH_IS_PeriR_PT_FR_Ddsa_han';
keys.sct(cs).X_sig='in_CH_IS_PeriR_PT_Ddsa_han';
keys.sct(cs).Y_sig='in_CH_IS_PeriR_PT_Ddsa_han';
keys.sct(cs).tt.tasktypes={'Ddsa_han'};
keys.sct(cs).tt.IC_for_criterion='in';
keys.sct(cs).tt.hands=[1 2];
keys.sct(cs).tt.choices=[0];
...
%Cue
cs=cs+1;
keys.sct(cs).X='in_IH_IS_Cue_CT_epoch_DF_Ddsa_han';
keys.sct(cs).Y='in_IH_IS_Cue_PT_epoch_DF_Ddsa_han';
keys.sct(cs).X_sig='in_IH_IS_Cue_PT_Ddsa_han'; % O > ^ o (filled) 
keys.sct(cs).Y_sig='in_IH_IS_Cue_PT_Ddsa_han';
keys.sct(cs).tt.tasktypes={'Ddsa_han'};
keys.sct(cs).tt.IC_for_criterion='in';
...
cs=cs+1;
keys.sct(cs).X='in_IH_CS_Cue_CT_epoch_DF_Ddsa_han';
keys.sct(cs).Y='in_IH_CS_Cue_PT_epoch_DF_Ddsa_han';
keys.sct(cs).X_sig='in_IH_CS_Cue_PT_Ddsa_han';
keys.sct(cs).Y_sig='in_IH_CS_Cue_PT_Ddsa_han';
keys.sct(cs).tt.tasktypes={'Ddsa_han'};
keys.sct(cs).tt.IC_for_criterion='in';
...
cs=cs+1;
keys.sct(cs).X='in_CH_CS_Cue_CT_epoch_DF_Ddsa_han';
keys.sct(cs).Y='in_CH_CS_Cue_PT_epoch_DF_Ddsa_han';
keys.sct(cs).X_sig='in_CH_CS_Cue_PT_Ddsa_han';
keys.sct(cs).Y_sig='in_CH_CS_Cue_PT_Ddsa_han';
keys.sct(cs).tt.tasktypes={'Ddsa_han'};
keys.sct(cs).tt.IC_for_criterion='in';
...
cs=cs+1;
keys.sct(cs).X='in_CH_IS_Cue_CT_epoch_DF_Ddsa_han';
keys.sct(cs).Y='in_CH_IS_Cue_PT_epoch_DF_Ddsa_han';
keys.sct(cs).X_sig='in_CH_IS_Cue_PT_Ddsa_han';
keys.sct(cs).Y_sig='in_CH_IS_Cue_PT_Ddsa_han';
keys.sct(cs).tt.tasktypes={'Ddsa_han'};
keys.sct(cs).tt.IC_for_criterion='in';
...
%Del
cs=cs+1;
keys.sct(cs).X='in_IH_IS_Del_CT_epoch_DF_Ddsa_han';
keys.sct(cs).Y='in_IH_IS_Del_PT_epoch_DF_Ddsa_han';
keys.sct(cs).X_sig='in_IH_IS_Del_PT_Ddsa_han'; % O > ^ o (filled) 
keys.sct(cs).Y_sig='in_IH_IS_Del_PT_Ddsa_han';
keys.sct(cs).tt.tasktypes={'Ddsa_han'};
keys.sct(cs).tt.IC_for_criterion='in';
...
cs=cs+1;
keys.sct(cs).X='in_IH_CS_Del_CT_epoch_DF_Ddsa_han';
keys.sct(cs).Y='in_IH_CS_Del_PT_epoch_DF_Ddsa_han';
keys.sct(cs).X_sig='in_IH_CS_Del_PT_Ddsa_han';
keys.sct(cs).Y_sig='in_IH_CS_Del_PT_Ddsa_han';
keys.sct(cs).tt.tasktypes={'Ddsa_han'};
keys.sct(cs).tt.IC_for_criterion='in';
...
cs=cs+1;
keys.sct(cs).X='in_CH_CS_Del_CT_epoch_DF_Ddsa_han';
keys.sct(cs).Y='in_CH_CS_Del_PT_epoch_DF_Ddsa_han';
keys.sct(cs).X_sig='in_CH_CS_Del_PT_Ddsa_han';
keys.sct(cs).Y_sig='in_CH_CS_Del_PT_Ddsa_han';
keys.sct(cs).tt.tasktypes={'Ddsa_han'};
keys.sct(cs).tt.IC_for_criterion='in';
...
cs=cs+1;
keys.sct(cs).X='in_CH_IS_Del_CT_epoch_DF_Ddsa_han';
keys.sct(cs).Y='in_CH_IS_Del_PT_epoch_DF_Ddsa_han';
keys.sct(cs).X_sig='in_CH_IS_Del_PT_Ddsa_han';
keys.sct(cs).Y_sig='in_CH_IS_Del_PT_Ddsa_han';
keys.sct(cs).tt.tasktypes={'Ddsa_han'};
keys.sct(cs).tt.IC_for_criterion='in';
...
%PreR
cs=cs+1;
keys.sct(cs).X='in_IH_IS_PreR_CT_epoch_DF_Ddsa_han';
keys.sct(cs).Y='in_IH_IS_PreR_PT_epoch_DF_Ddsa_han';
keys.sct(cs).X_sig='in_IH_IS_PreR_PT_Ddsa_han'; % O > ^ o (filled) 
keys.sct(cs).Y_sig='in_IH_IS_PreR_PT_Ddsa_han';
keys.sct(cs).tt.tasktypes={'Ddsa_han'};
keys.sct(cs).tt.IC_for_criterion='in';
...
cs=cs+1;
keys.sct(cs).X='in_IH_CS_PreR_CT_epoch_DF_Ddsa_han';
keys.sct(cs).Y='in_IH_CS_PreR_PT_epoch_DF_Ddsa_han';
keys.sct(cs).X_sig='in_IH_CS_PreR_PT_Ddsa_han';
keys.sct(cs).Y_sig='in_IH_CS_PreR_PT_Ddsa_han';
keys.sct(cs).tt.tasktypes={'Ddsa_han'};
keys.sct(cs).tt.IC_for_criterion='in';
...
cs=cs+1;
keys.sct(cs).X='in_CH_CS_PreR_CT_epoch_DF_Ddsa_han';
keys.sct(cs).Y='in_CH_CS_PreR_PT_epoch_DF_Ddsa_han';
keys.sct(cs).X_sig='in_CH_CS_PreR_PT_Ddsa_han';
keys.sct(cs).Y_sig='in_CH_CS_PreR_PT_Ddsa_han';
keys.sct(cs).tt.tasktypes={'Ddsa_han'};
keys.sct(cs).tt.IC_for_criterion='in';
...
cs=cs+1;
keys.sct(cs).X='in_CH_IS_PreR_CT_epoch_DF_Ddsa_han';
keys.sct(cs).Y='in_CH_IS_PreR_PT_epoch_DF_Ddsa_han';
keys.sct(cs).X_sig='in_CH_IS_PreR_PT_Ddsa_han';
keys.sct(cs).Y_sig='in_CH_IS_PreR_PT_Ddsa_han';
keys.sct(cs).tt.tasktypes={'Ddsa_han'};
keys.sct(cs).tt.IC_for_criterion='in';
...
%PeriR
cs=cs+1;
keys.sct(cs).X='in_IH_IS_PeriR_CT_epoch_DF_Ddsa_han';
keys.sct(cs).Y='in_IH_IS_PeriR_PT_epoch_DF_Ddsa_han';
keys.sct(cs).X_sig='in_IH_IS_PeriR_PT_Ddsa_han'; % O > ^ o (filled) 
keys.sct(cs).Y_sig='in_IH_IS_PeriR_PT_Ddsa_han';
keys.sct(cs).tt.tasktypes={'Ddsa_han'};
keys.sct(cs).tt.IC_for_criterion='in';
...
cs=cs+1;
keys.sct(cs).X='in_IH_CS_PeriR_CT_epoch_DF_Ddsa_han';
keys.sct(cs).Y='in_IH_CS_PeriR_PT_epoch_DF_Ddsa_han';
keys.sct(cs).X_sig='in_IH_CS_PeriR_PT_Ddsa_han';
keys.sct(cs).Y_sig='in_IH_CS_PeriR_PT_Ddsa_han';
keys.sct(cs).tt.tasktypes={'Ddsa_han'};
keys.sct(cs).tt.IC_for_criterion='in';
...
cs=cs+1;
keys.sct(cs).X='in_CH_CS_PeriR_CT_epoch_DF_Ddsa_han';
keys.sct(cs).Y='in_CH_CS_PeriR_PT_epoch_DF_Ddsa_han';
keys.sct(cs).X_sig='in_CH_CS_PeriR_PT_Ddsa_han';
keys.sct(cs).Y_sig='in_CH_CS_PeriR_PT_Ddsa_han';
keys.sct(cs).tt.tasktypes={'Ddsa_han'};
keys.sct(cs).tt.IC_for_criterion='in';
...
cs=cs+1;
keys.sct(cs).X='in_CH_IS_PeriR_CT_epoch_DF_Ddsa_han';
keys.sct(cs).Y='in_CH_IS_PeriR_PT_epoch_DF_Ddsa_han';
keys.sct(cs).X_sig='in_CH_IS_PeriR_PT_Ddsa_han';
keys.sct(cs).Y_sig='in_CH_IS_PeriR_PT_Ddsa_han';
keys.sct(cs).tt.tasktypes={'Ddsa_han'};
keys.sct(cs).tt.IC_for_criterion='in';
