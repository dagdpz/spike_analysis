...
keys.project_version='MIP_dPul_inj_choi';
...
keys.position_and_plotting_arrangements             ={'hands_inactivation_in_ch'};
...
keys.sct(cc).tt.tasktypes={'Ddre_han'};
keys.sct(cc).tt.IC_for_criterion='ch';
keys.sct(cc).tt.hands=[1 2];
...
% cc=cc+1;
% keys.sct(cc).X='ch_IH_IS_Del_CT_FR_Ddre_han';
% keys.sct(cc).Y='ch_IH_IS_Del_PT_FR_Ddre_han';
% keys.sct(cc).X_sig='ch_IH_IS_Del_PT_Ddre_han'; % O > ^ o (filled) 
% keys.sct(cc).Y_sig='ch_IH_IS_Del_PT_Ddre_han';
% keys.sct(cc).tt.tasktypes={'Ddre_han'};
% keys.sct(cc).tt.IC_for_criterion='ch';
% keys.sct(cc).tt.hands=[1 2];
...
% 
% cc=cc+1;
% keys.sct(cc).X='ch_IH_CS_Del_CT_FR_Ddre_han';
% keys.sct(cc).Y='ch_IH_CS_Del_PT_FR_Ddre_han';
% keys.sct(cc).X_sig='ch_IH_CS_Del_PT_Ddre_han'; % O > ^ o (filled) 
% keys.sct(cc).Y_sig='ch_IH_CS_Del_PT_Ddre_han';
% keys.sct(cc).tt.tasktypes={'Ddre_han'};
% keys.sct(cc).tt.IC_for_criterion='ch';
% keys.sct(cc).tt.hands=[1 2];
...
% 
% cc=cc+1;
% keys.sct(cc).X='ch_CH_CS_Del_CT_FR_Ddre_han';
% keys.sct(cc).Y='ch_CH_CS_Del_PT_FR_Ddre_han';
% keys.sct(cc).X_sig='ch_CH_CS_Del_PT_Ddre_han'; % O > ^ o (filled) 
% keys.sct(cc).Y_sig='ch_CH_CS_Del_PT_Ddre_han';
% keys.sct(cc).tt.tasktypes={'Ddre_han'};
% keys.sct(cc).tt.IC_for_criterion='ch';
% keys.sct(cc).tt.hands=[1 2];
...
% 
% cc=cc+1;
% keys.sct(cc).X='ch_CH_IS_Del_CT_FR_Ddre_han';
% keys.sct(cc).Y='ch_CH_IS_Del_PT_FR_Ddre_han';
% keys.sct(cc).X_sig='ch_CH_IS_Del_PT_Ddre_han'; % O > ^ o (filled) 
% keys.sct(cc).Y_sig='ch_CH_IS_Del_PT_Ddre_han';
% keys.sct(cc).tt.tasktypes={'Ddre_han'};
% keys.sct(cc).tt.IC_for_criterion='ch';
% keys.sct(cc).tt.hands=[1 2];
