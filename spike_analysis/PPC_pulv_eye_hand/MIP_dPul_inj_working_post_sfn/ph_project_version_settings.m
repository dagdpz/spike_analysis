...
keys.project_version='MIP_dPul_inj_working';
...
keys.ANOVAS_PER_TYPE(4).positions          ={'INI','Facq','Fhol','Cue','Del','PreR','PeriR','PostR','Thol'}';
...
keys.tt.type_effectors                   ={'Ddre'}; % This is now used in ph_get_filelist !
keys.tt.hands                       =[1 2];
