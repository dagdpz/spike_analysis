...
keys.project_version='MIP_Inj_Control_20181019';
...
keys.WINDOWS_PER_TYPE{4}={...
    'Delay Period', 6,	-0.33,  1.32;... %1.35
    'Reach',        62,	-0.32,  0.7;... %-0.35
    };  
...
%Del
cs=cs+1;
keys.sct(cs).X='in_IH_IS_Del_CT_FR_Ddre_han';
keys.sct(cs).Y='in_IH_IS_Del_PT_FR_Ddre_han';
keys.sct(cs).X_sig='in_IH_IS_Del_PT_Ddre_han'; % O > ^ o (filled) 
keys.sct(cs).Y_sig='in_IH_IS_Del_PT_Ddre_han';
keys.sct(cs).tt.tasktypes={'Ddre_han'};
keys.sct(cs).tt.IC_for_criterion='in';
keys.sct(cs).tt.hands=[1 2];
keys.sct(cs).tt.choices=[0];
...
cs=cs+1;
keys.sct(cs).X='in_IH_CS_Del_CT_FR_Ddre_han';
keys.sct(cs).Y='in_IH_CS_Del_PT_FR_Ddre_han';
keys.sct(cs).X_sig='in_IH_CS_Del_PT_Ddre_han';
...
cs=cs+1;
keys.sct(cs).X='in_CH_CS_Del_CT_FR_Ddre_han';
keys.sct(cs).Y='in_CH_CS_Del_PT_FR_Ddre_han';
keys.sct(cs).X_sig='in_CH_CS_Del_PT_Ddre_han';
...
cs=cs+1;
keys.sct(cs).X='in_CH_IS_Del_CT_FR_Ddre_han';
keys.sct(cs).Y='in_CH_IS_Del_PT_FR_Ddre_han';
keys.sct(cs).X_sig='in_CH_IS_Del_PT_Ddre_han';
keys.sct(cs).Y_sig='in_CH_IS_Del_PT_Ddre_han';
keys.sct(cs).tt.tasktypes={'Ddre_han'};
keys.sct(cs).tt.IC_for_criterion='in';
keys.sct(cs).tt.hands=[1 2];
keys.sct(cs).tt.choices=[0];
...
%PeriR
cs=cs+1;
keys.sct(cs).X='in_IH_IS_PeriR_CT_FR_Ddre_han';
keys.sct(cs).Y='in_IH_IS_PeriR_PT_FR_Ddre_han';
keys.sct(cs).X_sig='in_IH_IS_PeriR_PT_Ddre_han'; % O > ^ o (filled) 
keys.sct(cs).Y_sig='in_IH_IS_PeriR_PT_Ddre_han';
keys.sct(cs).tt.tasktypes={'Ddre_han'};
keys.sct(cs).tt.IC_for_criterion='in';
keys.sct(cs).tt.hands=[1 2];
keys.sct(cs).tt.choices=[0];
...
cs=cs+1;
keys.sct(cs).X='in_IH_CS_PeriR_CT_FR_Ddre_han';
keys.sct(cs).Y='in_IH_CS_PeriR_PT_FR_Ddre_han';
keys.sct(cs).X_sig='in_IH_CS_PeriR_PT_Ddre_han';
...
cs=cs+1;
keys.sct(cs).X='in_CH_CS_PeriR_CT_FR_Ddre_han';
keys.sct(cs).Y='in_CH_CS_PeriR_PT_FR_Ddre_han';
keys.sct(cs).X_sig='in_CH_CS_PeriR_PT_Ddre_han';
...
cs=cs+1;
keys.sct(cs).X='in_CH_IS_PeriR_CT_FR_Ddre_han';
keys.sct(cs).Y='in_CH_IS_PeriR_PT_FR_Ddre_han';
keys.sct(cs).X_sig='in_CH_IS_PeriR_PT_Ddre_han';
keys.sct(cs).Y_sig='in_CH_IS_PeriR_PT_Ddre_han';
keys.sct(cs).tt.tasktypes={'Ddre_han'};
keys.sct(cs).tt.IC_for_criterion='in';
keys.sct(cs).tt.hands=[1 2];
keys.sct(cs).tt.choices=[0];
...
%Cue
cs=cs+1;
keys.sct(cs).X='in_IH_IS_Cue_CT_epoch_DF_Ddre_han';
keys.sct(cs).Y='in_IH_IS_Cue_PT_epoch_DF_Ddre_han';
keys.sct(cs).X_sig='in_IH_IS_Cue_PT_Ddre_han'; % O > ^ o (filled) 
keys.sct(cs).Y_sig='in_IH_IS_Cue_PT_Ddre_han';
keys.sct(cs).tt.tasktypes={'Ddre_han'};
keys.sct(cs).tt.IC_for_criterion='in';
...
cs=cs+1;
keys.sct(cs).X='in_IH_CS_Cue_CT_epoch_DF_Ddre_han';
keys.sct(cs).Y='in_IH_CS_Cue_PT_epoch_DF_Ddre_han';
keys.sct(cs).X_sig='in_IH_CS_Cue_PT_Ddre_han';
keys.sct(cs).Y_sig='in_IH_CS_Cue_PT_Ddre_han';
keys.sct(cs).tt.tasktypes={'Ddre_han'};
keys.sct(cs).tt.IC_for_criterion='in';
...
cs=cs+1;
keys.sct(cs).X='in_CH_CS_Cue_CT_epoch_DF_Ddre_han';
keys.sct(cs).Y='in_CH_CS_Cue_PT_epoch_DF_Ddre_han';
keys.sct(cs).X_sig='in_CH_CS_Cue_PT_Ddre_han';
keys.sct(cs).Y_sig='in_CH_CS_Cue_PT_Ddre_han';
keys.sct(cs).tt.tasktypes={'Ddre_han'};
keys.sct(cs).tt.IC_for_criterion='in';
...
cs=cs+1;
keys.sct(cs).X='in_CH_IS_Cue_CT_epoch_DF_Ddre_han';
keys.sct(cs).Y='in_CH_IS_Cue_PT_epoch_DF_Ddre_han';
keys.sct(cs).X_sig='in_CH_IS_Cue_PT_Ddre_han';
keys.sct(cs).Y_sig='in_CH_IS_Cue_PT_Ddre_han';
keys.sct(cs).tt.tasktypes={'Ddre_han'};
keys.sct(cs).tt.IC_for_criterion='in';
...
%Del
cs=cs+1;
keys.sct(cs).X='in_IH_IS_Del_CT_epoch_DF_Ddre_han';
keys.sct(cs).Y='in_IH_IS_Del_PT_epoch_DF_Ddre_han';
keys.sct(cs).X_sig='in_IH_IS_Del_PT_Ddre_han'; % O > ^ o (filled) 
keys.sct(cs).Y_sig='in_IH_IS_Del_PT_Ddre_han';
keys.sct(cs).tt.tasktypes={'Ddre_han'};
keys.sct(cs).tt.IC_for_criterion='in';
...
cs=cs+1;
keys.sct(cs).X='in_IH_CS_Del_CT_epoch_DF_Ddre_han';
keys.sct(cs).Y='in_IH_CS_Del_PT_epoch_DF_Ddre_han';
keys.sct(cs).X_sig='in_IH_CS_Del_PT_Ddre_han';
keys.sct(cs).Y_sig='in_IH_CS_Del_PT_Ddre_han';
keys.sct(cs).tt.tasktypes={'Ddre_han'};
keys.sct(cs).tt.IC_for_criterion='in';
...
cs=cs+1;
keys.sct(cs).X='in_CH_CS_Del_CT_epoch_DF_Ddre_han';
keys.sct(cs).Y='in_CH_CS_Del_PT_epoch_DF_Ddre_han';
keys.sct(cs).X_sig='in_CH_CS_Del_PT_Ddre_han';
keys.sct(cs).Y_sig='in_CH_CS_Del_PT_Ddre_han';
keys.sct(cs).tt.tasktypes={'Ddre_han'};
keys.sct(cs).tt.IC_for_criterion='in';
...
cs=cs+1;
keys.sct(cs).X='in_CH_IS_Del_CT_epoch_DF_Ddre_han';
keys.sct(cs).Y='in_CH_IS_Del_PT_epoch_DF_Ddre_han';
keys.sct(cs).X_sig='in_CH_IS_Del_PT_Ddre_han';
keys.sct(cs).Y_sig='in_CH_IS_Del_PT_Ddre_han';
keys.sct(cs).tt.tasktypes={'Ddre_han'};
keys.sct(cs).tt.IC_for_criterion='in';
...
%PreR
cs=cs+1;
keys.sct(cs).X='in_IH_IS_PreR_CT_epoch_DF_Ddre_han';
keys.sct(cs).Y='in_IH_IS_PreR_PT_epoch_DF_Ddre_han';
keys.sct(cs).X_sig='in_IH_IS_PreR_PT_Ddre_han'; % O > ^ o (filled) 
keys.sct(cs).Y_sig='in_IH_IS_PreR_PT_Ddre_han';
keys.sct(cs).tt.tasktypes={'Ddre_han'};
keys.sct(cs).tt.IC_for_criterion='in';
...
cs=cs+1;
keys.sct(cs).X='in_IH_CS_PreR_CT_epoch_DF_Ddre_han';
keys.sct(cs).Y='in_IH_CS_PreR_PT_epoch_DF_Ddre_han';
keys.sct(cs).X_sig='in_IH_CS_PreR_PT_Ddre_han';
keys.sct(cs).Y_sig='in_IH_CS_PreR_PT_Ddre_han';
keys.sct(cs).tt.tasktypes={'Ddre_han'};
keys.sct(cs).tt.IC_for_criterion='in';
...
cs=cs+1;
keys.sct(cs).X='in_CH_CS_PreR_CT_epoch_DF_Ddre_han';
keys.sct(cs).Y='in_CH_CS_PreR_PT_epoch_DF_Ddre_han';
keys.sct(cs).X_sig='in_CH_CS_PreR_PT_Ddre_han';
keys.sct(cs).Y_sig='in_CH_CS_PreR_PT_Ddre_han';
keys.sct(cs).tt.tasktypes={'Ddre_han'};
keys.sct(cs).tt.IC_for_criterion='in';
...
cs=cs+1;
keys.sct(cs).X='in_CH_IS_PreR_CT_epoch_DF_Ddre_han';
keys.sct(cs).Y='in_CH_IS_PreR_PT_epoch_DF_Ddre_han';
keys.sct(cs).X_sig='in_CH_IS_PreR_PT_Ddre_han';
keys.sct(cs).Y_sig='in_CH_IS_PreR_PT_Ddre_han';
keys.sct(cs).tt.tasktypes={'Ddre_han'};
keys.sct(cs).tt.IC_for_criterion='in';
...
%PeriR
cs=cs+1;
keys.sct(cs).X='in_IH_IS_PeriR_CT_epoch_DF_Ddre_han';
keys.sct(cs).Y='in_IH_IS_PeriR_PT_epoch_DF_Ddre_han';
keys.sct(cs).X_sig='in_IH_IS_PeriR_PT_Ddre_han'; % O > ^ o (filled) 
keys.sct(cs).Y_sig='in_IH_IS_PeriR_PT_Ddre_han';
keys.sct(cs).tt.tasktypes={'Ddre_han'};
keys.sct(cs).tt.IC_for_criterion='in';
...
cs=cs+1;
keys.sct(cs).X='in_IH_CS_PeriR_CT_epoch_DF_Ddre_han';
keys.sct(cs).Y='in_IH_CS_PeriR_PT_epoch_DF_Ddre_han';
keys.sct(cs).X_sig='in_IH_CS_PeriR_PT_Ddre_han';
keys.sct(cs).Y_sig='in_IH_CS_PeriR_PT_Ddre_han';
keys.sct(cs).tt.tasktypes={'Ddre_han'};
keys.sct(cs).tt.IC_for_criterion='in';
...
cs=cs+1;
keys.sct(cs).X='in_CH_CS_PeriR_CT_epoch_DF_Ddre_han';
keys.sct(cs).Y='in_CH_CS_PeriR_PT_epoch_DF_Ddre_han';
keys.sct(cs).X_sig='in_CH_CS_PeriR_PT_Ddre_han';
keys.sct(cs).Y_sig='in_CH_CS_PeriR_PT_Ddre_han';
keys.sct(cs).tt.tasktypes={'Ddre_han'};
keys.sct(cs).tt.IC_for_criterion='in';
...
cs=cs+1;
keys.sct(cs).X='in_CH_IS_PeriR_CT_epoch_DF_Ddre_han';
keys.sct(cs).Y='in_CH_IS_PeriR_PT_epoch_DF_Ddre_han';
keys.sct(cs).X_sig='in_CH_IS_PeriR_PT_Ddre_han';
keys.sct(cs).Y_sig='in_CH_IS_PeriR_PT_Ddre_han';
keys.sct(cs).tt.tasktypes={'Ddre_han'};
keys.sct(cs).tt.IC_for_criterion='in';
