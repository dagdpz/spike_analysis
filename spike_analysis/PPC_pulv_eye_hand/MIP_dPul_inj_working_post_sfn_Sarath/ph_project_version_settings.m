...
keys.project_version='MIP_dPul_inj_working_post_sfn_SF';
...
keys.ANOVAS_PER_TYPE(4).spaceLR            ={'Fhol','Cue','Del','PreR','PeriR','Thol'}';
keys.ANOVAS_PER_TYPE(4).positions          ={'Fhol','Cue','Del','PreR','PeriR','Thol'}';
keys.ANOVAS_PER_TYPE(4).hands              ={'Fhol','Cue','Del','PreR','PeriR','Thol'}';
keys.ANOVAS_PER_TYPE(4).SxH                ={'Fhol','Cue','Del','PreR','PeriR','Thol'}';
keys.ANOVAS_PER_TYPE(4).main               ={'Fhol','Cue','Del','PreR','PeriR','Thol'}';
