...
keys.project_version='MIP_dPul_Inj_norm';
...
% cs=cs+1;
% keys.sct(cs).X='in_IH_IS_Cue_CT_DF_Ddre_han';
% keys.sct(cs).Y='in_IH_IS_Cue_PT_DF_Ddre_han';
...
% 
% cs=cs+1;
% keys.sct(cs).X='in_IH_CS_Cue_CT_DF_Ddre_han';
% keys.sct(cs).Y='in_IH_CS_Cue_PT_DF_Ddre_han';
...
% 
% cs=cs+1;
% keys.sct(cs).X='in_CH_CS_Cue_CT_DF_Ddre_han';
% keys.sct(cs).Y='in_CH_CS_Cue_PT_DF_Ddre_han';
...
% 
% cs=cs+1;
% keys.sct(cs).X='in_CH_IS_Cue_CT_DF_Ddre_han';
% keys.sct(cs).Y='in_CH_IS_Cue_PT_DF_Ddre_han';
...
% keys.sct(cs).tt.choices=[0];
cs=cs+1;
keys.sct(cs).X='in_IH_IS_Del_CT_DF_Ddre_han';
keys.sct(cs).Y='in_IH_IS_Del_PT_DF_Ddre_han';
...
cs=cs+1;
keys.sct(cs).X='in_IH_CS_Del_CT_DF_Ddre_han';
keys.sct(cs).Y='in_IH_CS_Del_PT_DF_Ddre_han';
...
cs=cs+1;
keys.sct(cs).X='in_CH_CS_Del_CT_DF_Ddre_han';
keys.sct(cs).Y='in_CH_CS_Del_PT_DF_Ddre_han';
...
cs=cs+1;
keys.sct(cs).X='in_CH_IS_Del_CT_DF_Ddre_han';
keys.sct(cs).Y='in_CH_IS_Del_PT_DF_Ddre_han';
...
keys.sct(cs).X='in_IH_IS_PreR_CT_DF_Ddre_han';
keys.sct(cs).Y='in_IH_IS_PreR_PT_DF_Ddre_han';
...
cs=cs+1;
keys.sct(cs).X='in_IH_CS_PreR_CT_DF_Ddre_han';
keys.sct(cs).Y='in_IH_CS_PreR_PT_DF_Ddre_han';
...
cs=cs+1;
keys.sct(cs).X='in_CH_CS_PreR_CT_DF_Ddre_han';
keys.sct(cs).Y='in_CH_CS_PreR_PT_DF_Ddre_han';
...
cs=cs+1;
keys.sct(cs).X='in_CH_IS_PreR_CT_DF_Ddre_han';
keys.sct(cs).Y='in_CH_IS_PreR_PT_DF_Ddre_han';
