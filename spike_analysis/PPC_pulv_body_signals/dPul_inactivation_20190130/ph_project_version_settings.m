...
keys.project_version='dPul_inactivation_20190130';
...
keys.Magnus.date                         ='[20190130 20190130]';
...
keys.cal.min_spikes_per_unit            =20;                        % excluding units that have in total less spikes (workaround for sortcode assignment bug) - to be removed
...
keys.tt.tasktypes                   ={'Dcfr_han'}; % typically only one tasktype defines
keys.tt.hands                       =[1 2];
...
keys.tt.selection                   ={'target','dPul_R'};                         % easy to use if there is a parameter in the tuning table for which you want your cells to have the same value
