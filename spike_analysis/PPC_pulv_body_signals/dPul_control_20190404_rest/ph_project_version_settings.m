...
keys.project_version='dPul_control_20190404_rest';
...
keys.ANOVAS_PER_TYPE(1).spaceLR            ={}';
keys.ANOVAS_PER_TYPE(1).positions          ={}';
keys.ANOVAS_PER_TYPE(1).hands              ={}';
keys.ANOVAS_PER_TYPE(1).SxH                ={}';
keys.ANOVAS_PER_TYPE(1).main               ={}';
...
keys.tt.tasktypes                   ={'rest_han'}; % typically only one tasktype defines
keys.tt.hands                       =[];
keys.tt.choices                     =[]; %IMPORTANT: and also not really perfect, for choice trials trial criterion is applied by hemifield, not by position.
