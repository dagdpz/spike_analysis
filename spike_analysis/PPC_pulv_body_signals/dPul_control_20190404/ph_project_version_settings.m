...
keys.project_version='dPul_control_20190404';
...
keys.tt.selection                   ={'target','dPul_L'};                         % easy to use if there is a parameter in the tuning table for which you want your cells to have the same value
