...
keys.project_version='MIP_inactivation';
...
keys.Magnus.date                         ='[20190124 20190124]';
...
keys.cal.min_trials_per_condition       =1;
...
keys.tt.combine_tuning_properties   ={'hand_tuning','in_IH_Facq_epoch_Dcfr_han','in_CH_Facq_epoch_Dcfr_han'}; % results in enen/ensu/suen/en-/-en/su-/-su/--
