...
keys.project_version='MIP_control_20190320';
...
keys.Magnus.date                         ='[20190320 20190320]';
...
keys.cal.min_spikes_per_unit            =50;                        % excluding units that have in total less spikes (workaround for sortcode assignment bug) - to be removed
 keys.cal.perturbation_groups            ={0,[2,3,4,5]};       % which perturbation values from excel table will be assigned to control and perturbation for comparisons and population analysis
...
keys.ANOVAS_PER_TYPE(4).positions          ={'INI','Facq','Fhol','Cue','Del','PreR','PeriR','Thol'}';
