...
keys.project_version='MIP_control_20190208';
...
%% to check carefully
% keys.position_and_plotting_arrangements             ={'hands_choices'};
 keys.position_and_plotting_arrangements             ={'hands_inactivation'};

%% computation settings
keys.cal.datasets                   =[3];
keys.cal.effectors                  =[6];
...
keys.cal.min_trials_per_condition       =4;                         % minimum trials per conditon (look at ph_arrange_positions to see how conditions are defined)
...
keys.cal.perturbation_groups            ={0,[2,3,4]};       % which perturbation values from excel table will be assigned to control and perturbation for comparisons and population analysis
...
keys.ANOVAS_PER_TYPE(4).spaceLR            ={'INI','Facq','Fhol','Cue','Del','PreR','PeriR','Thol'}';
keys.ANOVAS_PER_TYPE(4).positions          ={'Facq','Fhol','Cue','Del','PreR','PeriR','Thol'}';
keys.ANOVAS_PER_TYPE(4).hands              ={'INI','Facq','Fhol','Cue','Del','PreR','PeriR','Thol'}';
keys.ANOVAS_PER_TYPE(4).SxH                ={'INI','Facq','Fhol','Cue','Del','PreR','PeriR','Thol'}';
keys.ANOVAS_PER_TYPE(4).main               ={'INI','Facq','Fhol','Cue','Del','PreR','PeriR','Thol'}';
...
keys.tt.tasktypes                   ={'Dcfr'}; % typically only one tasktype defines
keys.tt.hands                       =[1 2];
...
keys.tt.selection                   ={'target','MIPa_R'};                         % easy to use if there is a parameter in the tuning table for which you want your cells to have the same value
...
keys.tt.combine_tuning_properties   ={'hand_tuning','in_IH_Facq_epoch_Dcfr','in_CH_Facq_epoch_Dcfr'}; % results in enen/ensu/suen/en-/-en/su-/-su/--
