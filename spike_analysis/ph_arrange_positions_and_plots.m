...
% keys.hnd_ptb_colors_L=[[1;2/3;1/3]*cols.NH_LS_IN;[1;2/3;1/3]*cols.LH_LS_IN;[1;2/3;1/3]*cols.RH_LS_IN]/255;
% keys.hnd_ptb_colors_R=[[1;2/3;1/3]*cols.NH_RS_IN;[1;2/3;1/3]*cols.LH_RS_IN;[1;2/3;1/3]*cols.RH_RS_IN]/255;
% keys.hnd_ptb_colors  =[[1;2/3;1/3]*cols.NH_IN   ;[1;2/3;1/3]*cols.LH_IN   ;[1;2/3;1/3]*cols.RH_IN   ]/255;
