...
for u=1:numel(population)
    ...
    fields_to_shorten={'FR_average','accepted','stability_rating','exclusion_reason','SNR_rating','block','run','n','trial'};
    ...
    population(u).FR                =nanmean([population(u).FR_average([population(u).accepted])]);
end
end